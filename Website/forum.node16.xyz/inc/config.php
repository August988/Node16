...
$config['database']['database'] = 'nodexyz_mybb549';
$config['database']['table_prefix'] = 'mybb6l_';

$config['database']['hostname'] = 'localhost';
$config['database']['username'] = 'nodexyz_mybb549';
$config['database']['password'] = 'pSL3I(26S)';
