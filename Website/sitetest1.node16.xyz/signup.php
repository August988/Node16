    ...
    ?>
		...
		<div id="Sidebars">
			...
			<div id="AlreadyRegistered">
				...
				<p>If you have already registered but you still need to download the game installer, go directly to <a id="ctl00_cphLUCKBLOX_HyperLinkDownload" href="data/release/Node16Launcher.exe">download</a>.</p>
