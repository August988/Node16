...
function template_html_above()
{
	...
	loadCSSFile('https://use.fontawesome.com/releases/v6.3.0/css/all.css', array('external' => true));
...
{		
	...
	echo '
		...
		echo (isset($settings['custom_forum_width']) && (bool) $settings['custom_forum_width'] !== false) ? '<div class="top_info_container" style="max-width: ' . $settings['custom_forum_width'] . '">' : '<div class="top_info_container">';
...
/* The Footer */
function template_customfooter ()
{
	global $context, $settings, $txt, $scripturl, $modSettings;
	...
	echo (!empty($settings['custom_forum_width'])) ? '<div class="inner_wrap" style="max-width: ' . $settings['custom_forum_width'] . '">' : '<div class="inner_wrap">';
		...
		if (!empty($settings['footer_menu_enable']))
		{	
			echo ' <div class="footer_top">';	
				echo'
				<ul class="footer_custom_links">';
	
				    if((!empty($settings['footer_menu_link_name_1']) && !empty($settings['footer_menu_link_1'])))
				echo '
					<li><a href="'. (!empty($settings['footer_menu_link_1']) ?  $settings['footer_menu_link_1'] : $scripturl). '" title="' . $settings['footer_menu_link_name_1'] . '">'. (!empty($settings['footer_menu_image_url_1']) ?  '<img src="'. $settings['footer_menu_image_url_1']. '" alt="' . $settings['footer_menu_link_name_1'] . '" title="' . $settings['footer_menu_link_name_1'] . '" >' : '<i class=" fa-solid fa-link"></i>' . $settings['footer_menu_link_name_1']) . '</a></li>';
					
				    if((!empty($settings['footer_menu_link_name_2']) && !empty($settings['footer_menu_link_2'])))
				echo '
					<li><a href="'. (!empty($settings['footer_menu_link_2']) ?  $settings['footer_menu_link_2'] : $scripturl). '" title="' . $settings['footer_menu_link_name_2'] .  '">'. (!empty($settings['footer_menu_image_url_2']) ?  '<img src="'. $settings['footer_menu_image_url_2']. '" alt="' . $settings['footer_menu_link_name_2'] . '" title="' . $settings['footer_menu_link_name_2'] . '" >' : '<i class=" fa-solid fa-link"></i>' . $settings['footer_menu_link_name_2']) . '</a></li>';
					
				    if((!empty($settings['footer_menu_link_name_3']) && !empty($settings['footer_menu_link_3'])))
				echo '
				    <li><a href="'. (!empty($settings['footer_menu_link_3']) ?  $settings['footer_menu_link_3'] : $scripturl). '" title="' . $settings['footer_menu_link_name_3'] .  '">'. (!empty($settings['footer_menu_image_url_3']) ?  '<img src="'. $settings['footer_menu_image_url_3']. '" alt="' . $settings['footer_menu_link_name_3'] . '" title="' . $settings['footer_menu_link_name_3'] . '" >' : '<i class=" fa-solid fa-link"></i>' . $settings['footer_menu_link_name_3']) . '</a></li>';
					
				    if((!empty($settings['footer_menu_link_name_3']) && !empty($settings['footer_menu_link_4'])))
				echo '
				    <li><a href="'. (!empty($settings['footer_menu_link_4']) ?  $settings['footer_menu_link_4'] : $scripturl). '" title="' . $settings['footer_menu_link_name_4'] .  '">'. (!empty($settings['footer_menu_image_url_4']) ?  '<img src="'. $settings['footer_menu_image_url_4']. '" alt="' . $settings['footer_menu_link_name_4'] . '" title="' . $settings['footer_menu_link_name_4'] . '" >' : '<i class=" fa-solid fa-link"></i>' . $settings['footer_menu_link_name_4']) . '</a></li>';
	...
	echo '
		<ul>
			...
			<li class="copyright">', theme_copyright(), ' | <a href="https://www.simplemachines.org/community/index.php?action=profile;u=218416">GreyedOut Theme By: TwitchisMental</a></li>
			</ul>';
