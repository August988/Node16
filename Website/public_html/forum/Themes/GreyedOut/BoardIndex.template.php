...
function template_info_center()
{
	...
	<div class="roundframe" id="info_center">
		...
		<div class="border-wrap" id="upshrink_stats"', empty($options['collapse_header_ic']) ? '' : ' style="display: none;"', '>';
	...
	elseif (!empty($context['latest_posts']))
	{
		echo '
		 	  <div class="recent_grid_row">               
				<div class="recent_grid_column recentpost"><strong> ', $txt['message'], '</strong></div>
				<div class="recent_grid_column recentposter"><strong>', $txt['author'], '</strong></div>
				<div class="recent_grid_column recentboard"><strong>', $txt['board'], '</strong></div>
				<div class="recent_grid_column recenttime"><strong>', $txt['date'], '</strong></div>
			  </div>';
		...
		foreach ($context['latest_posts'] as $post)
			...
			<div class="recent_grid_row">               
				<div class="recent_grid_column recentpost"><strong>', $post['link'], '</strong></div>
				<div class="recent_grid_column recentposter">', $post['poster']['link'], '</div>
				<div class="recent_grid_column recentboard">', $post['board']['link'], '</div>
				<div class="recent_grid_column recenttime">', $post['time'], '</div>
			  </div>';
	...
	echo '
			<div class="sub_bar">
			  ...
			  <div class="boardstats_grid_column">               
				...
				<div class="boardstats_grid_row">  ', $context['common_stats']['boardindex_total_posts'], '</div>
			  </div>';
}
