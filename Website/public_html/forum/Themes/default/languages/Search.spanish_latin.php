...
$txt['search_method_fulltext_cannot_create'] = 'no se puede crear porque la búsqueda de texto completo (fulltext) no está soportada por tu versión de MySQL';
...
$txt['search_warning_ignored_word'] = 'El siguiente término ha sido ignorado en tu búsqueda por ser demasiado corto';
$txt['search_warning_ignored_words'] = 'Los siguientes términos han sido ignorados en tu búsqueda por ser demasiado cortos';
$txt['search_adjust_submit'] = 'Por favor, revise la búsqueda';
$txt['search_did_you_mean'] = 'Puede que hayas intentado buscar por';

$txt['search_example'] = '<em>p.e.</em> "Nueve reinas" de Fabián Bielinsky -película';
...
$txt['spider_mode'] = 'Nivel de seguimiento del motor de búsqueda';
$txt['spider_mode_note'] = 'Ten en cuenta que para registrar todas las acciones de las arañas el seguimiento debe establecerse como "alto" o "muy alto". Los detalles sobre cada acción de las arañas sólo quedan registrados si el seguimiento se establece como "muy alto".';
...
$txt['spider_mode_vhigh'] = 'Agresivo';
...
$txt['spider_group_note'] = 'Para permitirte impedir que las arañas indexen algunas páginas.';
...
$txt['spider_remove_selected_confirm'] = '¿Estás seguro de que quieres eliminar estas arañas?-n-¡Se borrarán también todas las estadísticas asociadas!';
$txt['spiders_no_entries'] = 'No hay arañas configuradas actualmente.';

$txt['add_spider_desc'] = 'Desde esta página puedes editar los parámetros por los que una araña es categorizada. Si el agente de usuario de un invitado o su dirección IP coinciden con los introducidos a continuación, dicho invitado será detectado como una araña de motor de búsqueda y seguido de acuerdo a las preferencias del foro.';
...
$txt['spider_logs_info'] = 'Ten en cuenta que los registros de las acciones de cada motor de búsqueda sólo se realizarán si el seguimiento está seleccionado en "Alto" o "Muy Alto". Los detalles cada acción solo serán guardados si el seguimiento está en "Muy Alto".';
$txt['spider_disabled'] = 'Desactivado';
$txt['spider_log_empty_log'] = 'Limpiar registro';
$txt['spider_log_empty_log_confirm'] = '¿Estás seguro de que quieres limpiar el registro completamente?';
...
$txt['spider_stats_delete_older'] = 'Borrar todas las estadísticas de arañas para las arañas que no han sido detectadas en los últimos %1$s días.';
