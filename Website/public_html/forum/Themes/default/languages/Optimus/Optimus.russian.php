...
$txt['optimus_board_extend_title_set'] = array('Не добавлять', 'Перед названием раздела', 'После названия раздела');
$txt['optimus_topic_extend_title'] = 'Добавлять название раздела и форума к заголовкам тем';
$txt['optimus_topic_extend_title_set'] = array('Не добавлять', 'Перед названием темы', 'После названия темы');
...
$txt['optimus_show_keywords_on_message_index'] = 'Отображать ключевые слова в списках тем внутри разделов';
$txt['optimus_allow_keyword_phrases'] = 'Разрешить добавлять целые ключевые фразы';
...
$txt['optimus_counters_desc'] = 'Добавляйте и изменяйте всевозможный JS-код для подсчета статистики/посещений форума.';

$txt['optimus_head_code'] = 'Невидимый код с загрузкой в секции <strong>head</strong>';
$txt['optimus_head_code_subtext'] = 'Например, <a href="https://www.google.ru/analytics/" target="_blank" rel="noopener" class="bbc_link">Google Analytics</a> или <a href="https://www.google.com/adsense/start/" target="_blank" rel="noopener" class="bbc_link">Google AdSense</a>';
$txt['optimus_stat_code'] = 'Невидимый код с загрузкой в секции <strong>body</strong>';
...
$txt['optimus_count_code'] = 'Видимые счётчики (информеры, баннеры и т. д.)';
$txt['optimus_counters_css'] = 'Оформление блока с видимыми счётчиками (CSS-код)';
...
$txt['optimus_links'][0] = array('Правильный robots.txt для SMF', 'https://dragomano.ru/articles/pravilnyj-robotstxt-dlja-smf');
$txt['optimus_links'][1] = array('Проверка robots.txt', 'https://webmaster.yandex.ru/robots.xml');
