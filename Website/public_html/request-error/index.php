...
<html><!--<![endif]--><head>
    ...
    <meta property="description" content="error page">
...
<div class="request-error-page-content">
    <div class="default-error-page">
        ...
        <img src="https://images.rbxcdn.com/6333778afe194c8924d9b8f08d950710.png" class="error-image" alt="Error Image">
        <div class="action-buttons">
            <a class="btn-primary-md btn-fixed-width" title="Go to Previous Page" onclick="history.back();return false;" href="#">Back</a>
            <a class="btn-control-md btn-fixed-width" title="Return Home" href="/">Home</a>
        </div>
    </div>
</div>
