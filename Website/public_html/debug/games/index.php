...
<body>
    ...
    <div class="container card" style="width: 1000px; height: 700px;">
        <br>
        <h2>Add a Game</h2>
        <form action="../post/game.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label for="username">username (ownedBy):</label>
                <input type="text" class="form-control" id="ownedBy" name="ownedBy" placeholder="ROBLOX">
            </div>
            <div class="form-group">
                <label for="username">place name:</label>
                <input type="text" class="form-control" id="placeName" name="placeName" placeholder="name here">
            </div>
            <div class="form-group">
                <label for="username">place description:</label>
                <input type="text" class="form-control" id="placeDesc" name="placeDesc" placeholder="test">
            </div>
            <div class="form-group">
                <label for="visitCount">place visits:</label>
                <input type="number" class="form-control" id="placeVisits" name="placeVisits" placeholder="0">
            </div>
            <div class="form-group">
                <label for="placeLikes">place likes:</label>
                <input type="text" class="form-control" id="placeLikes" name="placeLikes" placeholder="0">
            </div>
            <div class="form-group">
                <label for="placeDislikes">place dislikes:</label>
                <input type="text" class="form-control" id="placeDislikes" name="placeDislikes" placeholder="0">
            </div>
