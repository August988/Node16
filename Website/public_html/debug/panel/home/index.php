...
<body>
    ...
    <div class="container card" style="width: 1000px; height: 700px;">
        <br>
        <h2 class="text-center">Debug Panel - Home</h2>
        <p class="text-center">you can't ban people here and do mod stuff, this is for devs only.</p>
        <a class="btn btn-primary" href="../users" role="button">Accounts</a>
        <a class="btn btn-primary" href="../games" role="button">Games</a>
        <br>
    </div>
</body>
</html>
