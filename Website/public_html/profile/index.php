...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $gameSql = "SELECT placeName, placeLikes, placeDislikes, placeVisits, placeDesc, placeImage FROM games WHERE ownedBy = '$username'";
        $gameResult = $conn->query($gameSql);

        $numGames = $gameResult->num_rows;
        ...
        <a href="game.php?id=1" class="game-item">
            <span class="game-thumb-content">
                <span class="game-thumb-wrapper">
                    <img class="game-thumb ng-isolate-scope" src="<?php echo $game['placeImage']; ?>" alt="<?php echo $game['placeName']; ?>" thumbnail="{&quot;Final&quot;:true,&quot;Url&quot;:&quot;<?php echo $game['placeImage']; ?>&quot;,&quot;RetryUrl&quot;:null}" image-retry="">
                </span>
            </span>
            <span class="rbx-game-title rbx-text-overflow" title="<?php echo $game['placeName']; ?>" ng-non-bindable="">
                <?php echo $game['placeName']; ?>
            </span>
            <span class="rbx-game-text-notes rbx-font-xs">
                <?php echo $game['placeVisits']; ?> Players Online
            </span>
            <span class="rbx-votes">
                <div class="vote-bar">
                    ...
                    <div class="voting-container" data-upvotes="1707" data-downvotes="163" data-voting-processed="true">
                        ...
                        <div class="votes" style="width: 10px">nul</div>
                        <div class="mask">
                ...
                <div class="vote-counts">
                    <div class="down-votes-count rbx-font-xs"><?php echo $game['placeDislikes']; ?></div>
                    <div class="up-votes-count rbx-font-xs"><?php echo $game['placeLikes']; ?></div>
                </div>
            </span>
            <span class="rbx-developer rbx-font-xs">
                by <cite class="rbx-link-sm" data-href="/user.php?id=1"><?php echo $username; ?></cite>
            </span>
        </a>
    </li>
    <br>
                            ...
                            <div class="slide-item-stats">
                                <ul class="hlist">
                                    <li class="list-item">
                                        ...
                                        <p class="slide-item-members-count rbx-font-bold">Unknown</p>
                                    </li>
                                    <li class="list-item">
