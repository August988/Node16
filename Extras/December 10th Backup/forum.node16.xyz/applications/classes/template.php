...
class TIDY_Template
{
    ...
    function __construct()
    {
        ...
        $this->addParam('bb_software_version', TidyBB_VERSION);
        ...
        $this->addParam(
            'editor_settings',
            '<link rel="stylesheet" href="' . SITE_URL . '/public/css/TidyBB.css" />
               ...
               <script type="text/javascript" src="' . SITE_URL . '/public/js/TidyBB.js"></script>
