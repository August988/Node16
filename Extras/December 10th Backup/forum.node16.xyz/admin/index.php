...
/*echo '<div class="col-md-12">
      ...
      $v=simplexml_load_file("https://api.tidybb.co.uk/api.php?cmd=version");
      if (version_compare(TidyBB_VERSION, $v->versioning[0]->human, '<')) { 
...
echo $ADMIN->box(
    'Dashboard',
    'This forum is powered by TidyBB <strong>' . TidyBB_VERSION . '</strong>.' . @$alert,
    '<table class="table">
         <thead>
           <tr>
...
echo $ADMIN->box(
    ...
    '<form action="" method="POST">
       ...
       <br />
       You can run commands that are available in TidyBB.
       <br />
       <h4>Commands</h4>
...
$getnews=simplexml_load_file("https://api.tidybb.co.uk/api.php?cmd=newsfeed");
...
echo $ADMIN->box(
    'TidyBB News Feed <a href="https://api.tidybb.co.uk/api.php?cmd=newsfeed&view=all" target="_blank" class="btn btn-default btn-xs">View Archive</a>',
    'Get all the latest news & updates from TidyBB.',
    $newsreader
);
