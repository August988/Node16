...
pcall(function() game:GetService("InsertService"):SetFreeModelUrl("http://www.node16.xyz/Game/Tools/InsertAsset.ashx?type=fm&q=%s&pg=%d&rs=%d") end) -- Used for free model search (insert tool)
pcall(function() game:GetService("InsertService"):SetFreeDecalUrl("http://www.node16.xyz/Game/Tools/InsertAsset.ashx?type=fd&q=%s&pg=%d&rs=%d") end) -- Used for free decal search (insert tool)
...
pcall(function() game:GetService("Players"):SetBuildUserPermissionsUrl("http://www.node16.xyz//Game/BuildActionPermissionCheck.ashx?assetId=0&userId=%d&isSolo=true") end)
...
function doVisit()
	...
	player.CharacterAppearance = "http://www.node16.xyz/Asset/CharacterFetch.ashx?userId=1&placeId=0"
	...
	if not inStudio and false then
		...
		visit:SetPing("http://www.node16.xyz/Game/ClientPresence.ashx?version=old&PlaceID=0", 120)
...
if success then
	...
	if not inStudio then
		if false then
			game:HttpPost("http://www.node16.xyz/Error/Lua.ashx?", "Visit.lua: " .. err)
		end
	end
end
